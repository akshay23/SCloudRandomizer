...
- (void)drawPlaceholderInRect:(CGRect)rect;
{
    ...
    NSArray *values = [NSArray arrayWithObjects:self.font, nil];
    [self.placeholder drawInRect:rect withAttributes:[NSDictionary dictionaryWithObjects:values forKeys:keys]];
}
