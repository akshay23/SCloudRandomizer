                                ...
                                AudioQueueBufferRef buffer)
{
    AudioQueueFreeBuffer(inAudioQueue, buffer);
        SCAudioBufferQueue *queue = (__bridge SCAudioBufferQueue *)clientData;
                                 ...
                                 const void *propertyValue)
{
        ...
        SCAudioBufferQueue *queue = (__bridge SCAudioBufferQueue *)clientData;
        [queue audioSessionRouteChangedWithChangeDict:(__bridge NSDictionary *)propertyValue];
}
#endif
               ...
               magicCookieData:(NSData *)magicCookieData;
{
    if (self = [super init]) {
        ...
        if (magicCookieData) {
            ...
            UInt32 cookieDataSize = (int)[magicCookieData length];
...
- (void)enqueueData:(NSData *)data withPacketDescriptions:(SCAudioStreamPacketDescriptions *)packetDescriptions endOfStream:(BOOL)eos;
{
    ...
    buffer->mAudioDataByteSize = (int)bufferSize;
